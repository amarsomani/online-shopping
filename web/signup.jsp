<%-- 
    Document   : signup
    Created on : Jan 27, 2018, 12:00:45 AM
    Author     : amar
--%>
...
//    if(referrer.contains("/signupServlet"))
//    {
 %>
<!-- <script>
    document.getElementById("msge").innerHTML = "User already exists";
...
<body>
	...
	<% 
        ...
        <%
                  ...
                  {
                  // out.println("<font color = red size=4>This user already exists or this email id is already in use</font>");
                      %>
                      <script type="text/javascript"> 
                      alert("Email already exists");
                      documnent.getElementById("NAME").focus();
                      </script>
                      <%
                  }
              }
