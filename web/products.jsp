<%-- 
    Ddocument   : products
    Ccreated on : Jan 27, 2018, 12:39:04 AM
    Aauthor     : amar
--%>
	...
	<div class="header">
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
                                    <font color="white"><%out.println(a);%></font>
					<li class="dropdown head-dpdn">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-percent" aria-hidden="true"></i><%out.println(a);%><span class="caret"></span></a>
			...
			<div class="col-md-9 product-w3ls-right">
				...
				<div class="products-row">
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.jsp"><img src="images/iphone2.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Iphone</a></h5> 
								<h6><del>$120</del> $100</h6> 
								<form action="AddToCartServlet" method="post">
									<input type="hidden" name="pid" value="21" /> 
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Iphone"/> 
									<input type="hidden" name="amount" value="100.00"/> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
								</form>
							</div>
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"><h6>5% <br> Off</h6></div>
							<a href="single.jsp"><img src="images/tablet.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Tablet</a></h5> 
								<h6><del>$80</del> $68</h6> 
								<form action="AddToCartServlet" method="post">
									<input type="hidden" name="pid" value="22" />
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Tablet"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/ipad.jpg"  class="img-responsive" alt="img" width="250" height="300"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Ipad</a></h5> 
								<h6><del>$300</del> $200</h6> 
								<form action="AddToCartServlet" method="post">
									<input type="hidden" name="pid" value="23" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Ipad" /> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.jsp"><img src="images/featured_phone.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Featured Phone</a></h5> 
								<h6> $30</h6> 
								<form action="#" method="post">
									<input type="hidden" name="pid" value="24" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Featured_Phone" /> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/washing_machine.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Washing Machine</a></h5> 
								<h6><del>$200</del> $70</h6> 
								<form action="#" method="post">
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.jsp"><img src="images/air_conditioner.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Air Conditioner</a></h5> 
								<h6><del>$700</del> $400</h6> 
								<form action="#" method="post">
									<input type="hidden" name="pid" value="26" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Air Conditioner" /> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"></div>
							<a href="single.jsp"><img src="images/printer.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Printer</a></h5> 
								<h6><del>$100</del> $75</h6> 
								<form action="#" method="post">
									<input type="hidden" name="pid" value="27" />
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Printer"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.jsp"><img src="images/laptop1.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Laptop_1</a></h5> 
								<h6><del>$250</del> $200</h6> 
								<form action="#" method="post">
									<input type="hidden" name="pid" value="28" />
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Laptop_1"/> 
									<input type="hidden" name="amount" value="200.00"/> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
								</form>
							</div>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.jsp"><img src="images/laptop2.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Laptop_2</a></h5> 
								<h6><del>$200</del> $180</h6> 
								<form action="#" method="post">
									<input type="hidden" name="pid" value="29" />
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Laptop_2"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"><h6>20% <br> Off</h6></div>
							<a href="single.jsp"><img src="images/TV1.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">TV1</a></h5> 
								<h6><del>$200</del> $160</h6> 
								<form action="#" method="post">
									<input type="hidden" name="pid" value="30" />
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="TV 1"/> 
						...
						<div class="agile-products">
							<div class="new-tag"><h6>20% <br> Off</h6></div>
							<a href="single.jsp"><img src="images/TV2.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">TV 2</a></h5> 
								<h6><del>$250</del> $200</h6> 
								<form action="#" method="post">
									<input type="hidden" name="pid" value="31" />
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="TV 2"/> 
									<input type="hidden" name="amount" value="200.00"/> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button>
								</form>
							</div>
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"></div>
							<a href="single.jsp"><img src="images/gaming1.jpg" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Gaming_1</a></h5> 
								<h6>$150</h6> 
								<form action="#" method="post">
									<input type="hidden" name="pid" value="32" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Gaming_1" /> 
