<%-- 
    ...
    Created on : Jan 28, 2018, 3:50:29 PM
    Author     : amar
--%>
...
<!--					<input type="text" class="user" name="name" placeholder="Enter your Name" required="">-->
					...
					<input type="password" name="password" class="lock" placeholder="New Password" required="">
...
//               if(pass == cpass)
//                  response.sendRedirect("forgetServlet");
//               else
//              }
 //             try{
...
//                            {
//                            if(cd.signup(name, email, password))
//                            {
...
//                                   out.println("<font color=red>Couldn't signin please try again!!</font>");
//                            }
//              }
//              catch(Exception e)
//              {
