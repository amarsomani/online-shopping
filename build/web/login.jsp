<%-- 
    Document   : login
    Created on : Jan 27, 2018, 12:02:07 AM
    Author     : amar
--%>
	...
	<div class="login-page">
		<div class="container"> 
			...
			<div class="login-body">
                            <form id="myform" name="myform" action="LoginCode.jsp" method="post" onsubmit="javascript:return validate();">
                                <input type="text" class="user"  name="email" placeholder="Enter your email" required="" id="email" autofocus>
					<input type="password" name="password" class="lock" placeholder="Password" required="" id ="PASS">
                                        <input type="submit" value="login" >
					<div class="forgot-grid">
                                            <label class="checkbox"><input type="checkbox" name="checkbox" id="remember_me"><i></i>Remember me</label>
						<div class="forgot">
            ...
            if(md.checkLogin(email))
              {
                ...
                %>
                      ...
                      documnent.getElementById("email").focus();
                      </script>
                        <%
                }
            }
