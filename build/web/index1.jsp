<%-- 
    Document   : index
    Created on : Jan 27, 2018, 12:34:52 AM
    Author     : amar
--%>
			...
			<div class="w3ls-header-right">
				<ul>
                                    ...
                                    <li class="dropdown head-dpdn">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><%out.println(o1.toString());%><span class="caret"></span></a>
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				...
				<div class="header-cart"> 
					...
					<div class="cart"> 
						<form action="ViewCart.jsp" method="post" class="last"> 
