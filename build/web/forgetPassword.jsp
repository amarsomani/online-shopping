...
<script type="text/javascript">
    function validate()
    {
        ...
        var y = document.myform.cpassword.value;
...
<body>
          ...
          if(email != null)
          {
            ...
            if(md.checkLogin(email, pass))
                response.sendRedirect("index.jsp");
            else
            {
                out.println("<center><font color=red>Invalid email or password</font></center>");
	...
	<div class="forget-page">
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1">Forget Password</h3>  
			<div class="login-body">
				<form name="myform" action="forgetServlet" method="post" onsubmit="javascript:return validate();">
                                    <input type="text" class="user" name="email" placeholder="Enter your email" required="" >
					<input type="password" name="password" class="lock" placeholder="Password" required="" >
                                        <input type="password" name="cpassword" class="lock" placeholder="Confirm Password" required="" onkeydown="FxUserPress()">
