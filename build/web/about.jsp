<%-- 
    Document   : about
    Created on : Jan 27, 2018, 12:30:34 AM
    Author     : amar
--%>
			...
			<div class="w3ls-header-right">
				<ul>
					<li class="dropdown head-dpdn">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-percent" aria-hidden="true"></i><%=s%><span class="caret"></span></a>
